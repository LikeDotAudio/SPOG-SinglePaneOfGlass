...
const ICONS = [
  { id: 'control-rooms', label: 'CONTROL ROOMS', accent: '#646DCC', glyph: G.controlRooms },
  { id: 'floors',        label: 'FLOORS', accent: '#A06EB4', glyph: G.floors },
  { id: 'encoders',      label: 'ENCODERS', accent: '#FF3366', glyph: G.encoders },
  { id: 'edit-suites',   label: 'EDIT SUITES', accent: '#3FC1C9', glyph: G.editSuites },
  { id: 'test-tools',    label: 'TEST TOOLS', accent: '#C67825', glyph: G.testTools },
  { id: 'people',        label: 'PEOPLE', accent: '#78A05A', glyph: G.people },
];
