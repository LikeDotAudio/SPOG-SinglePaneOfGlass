...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=60',
    './js/util/color.js?v=60',
    './js/util/palette.js?v=60',
    './js/util/dom.js?v=60',
    './js/core/state.js?v=60',
    './js/ui/makeMediaGroup.js?v=60',
    './js/globals.js?v=60',
    './js/poolVideo.js?v=60',
    './js/poolAudio.js?v=60',
    './js/visuals.js?v=60',
    './js/matrix.js?v=60',
    './js/editors/core.js?v=60',
    './js/editors/iso-recorder.js?v=60',
    './js/editors/multi-viewer.js?v=60',
    './js/editors/vision-mixer.js?v=60',
    './js/editors/audio-mixer.js?v=60',
    './js/editors/intercom.js?v=60',
    './js/dragDrop.js?v=60',
    './js/touchDrag.js?v=60',
    './js/productions.js?v=60',
    './js/poolPlayout.js?v=60',
    './js/sources.js?v=60',
    './js/topbar.js?v=60',
    './js/app.js?v=60',
    './js/clock.js?v=60',
    './js/tutorial.js?v=60',
    './js/router-view.js?v=60',
    './js/captains-log.js?v=60',
    './js/portals.js?v=60',
    './js/lcars-pulse.js?v=60',
    './js/dest-selector.js?v=60',
    './js/dialog.js?v=60',
    './js/unroute.js?v=60',
