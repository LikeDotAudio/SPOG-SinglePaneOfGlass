...
const CACHE_VERSION = 'twist-v101';
...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=101',
    './js/util/color.js?v=101',
    './js/util/palette.js?v=101',
    './js/util/dom.js?v=101',
    './js/core/state.js?v=101',
    './js/ui/makeMediaGroup.js?v=101',
    './js/globals.js?v=101',
    './js/poolVideo.js?v=101',
    './js/poolAudio.js?v=101',
    './js/visuals.js?v=101',
    './js/matrix.js?v=101',
    './js/editors/core.js?v=101',
    './js/editors/iso-recorder.js?v=101',
    './js/editors/multi-viewer.js?v=101',
    './js/editors/vision-mixer.js?v=101',
    './js/editors/audio-mixer.js?v=101',
    './js/editors/intercom.js?v=101',
    './js/editors/camera-control.js?v=101',
    './js/editors/camera/styles.js?v=101',
    './js/editors/camera/state.js?v=101',
    './js/editors/camera/scopes.js?v=101',
    './js/editors/camera/bars.js?v=101',
    './js/editors/camera/maps.js?v=101',
    './js/editors/camera/controls.js?v=101',
    './js/editors/audio-monitor.js?v=101',
    './js/editors/ifb.js?v=101',
    './js/editors/stagebox-input.js?v=101',
    './js/editors/encoder.js?v=101',
    './js/editors/signaling.js?v=101',
    './js/editors/lighting.js?v=101',
    './js/editors/wysiwyg.js?v=101',
    './js/editors/multi.js?v=101',
    './js/dragDrop.js?v=101',
    './js/touchDrag.js?v=101',
    './js/productions.js?v=101',
    './js/poolPlayout.js?v=101',
    './js/sources.js?v=101',
    './js/topbar.js?v=101',
    './js/app.js?v=101',
    './js/auth.js?v=101',
    './js/schedule.js?v=101',
    './js/clock.js?v=101',
    './js/tutorial.js?v=101',
    './js/router-view.js?v=101',
    './js/captains-log.js?v=101',
    './js/portals.js?v=101',
    './js/lcars-pulse.js?v=101',
    './js/dest-selector.js?v=101',
    './js/dialog.js?v=101',
    './js/util/mono-emoji.js?v=101',
    './js/unroute.js?v=101',
    './js/source-filter.js?v=101',
