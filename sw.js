...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=56',
    './js/util/color.js?v=56',
    './js/util/palette.js?v=56',
    './js/util/dom.js?v=56',
    './js/core/state.js?v=56',
    './js/ui/makeMediaGroup.js?v=56',
    './js/globals.js?v=56',
    './js/poolVideo.js?v=56',
    './js/poolAudio.js?v=56',
    './js/visuals.js?v=56',
    './js/matrix.js?v=56',
    './js/editors/core.js?v=56',
    './js/editors/iso-recorder.js?v=56',
    './js/editors/multi-viewer.js?v=56',
    './js/editors/vision-mixer.js?v=56',
    './js/editors/audio-mixer.js?v=56',
    './js/editors/intercom.js?v=56',
    './js/dragDrop.js?v=56',
    './js/touchDrag.js?v=56',
    './js/productions.js?v=56',
    './js/poolPlayout.js?v=56',
    './js/sources.js?v=56',
    './js/topbar.js?v=56',
    './js/app.js?v=56',
    './js/clock.js?v=56',
    './js/tutorial.js?v=56',
    './js/router-view.js?v=56',
    './js/captains-log.js?v=56',
    './js/portals.js?v=56',
    './js/lcars-pulse.js?v=56',
    './js/dest-selector.js?v=56',
