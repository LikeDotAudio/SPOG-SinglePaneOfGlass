...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=67',
    './js/util/color.js?v=67',
    './js/util/palette.js?v=67',
    './js/util/dom.js?v=67',
    './js/core/state.js?v=67',
    './js/ui/makeMediaGroup.js?v=67',
    './js/globals.js?v=67',
    './js/poolVideo.js?v=67',
    './js/poolAudio.js?v=67',
    './js/visuals.js?v=67',
    './js/matrix.js?v=67',
    './js/editors/core.js?v=67',
    './js/editors/iso-recorder.js?v=67',
    './js/editors/multi-viewer.js?v=67',
    './js/editors/vision-mixer.js?v=67',
    './js/editors/audio-mixer.js?v=67',
    './js/editors/intercom.js?v=67',
    './js/dragDrop.js?v=67',
    './js/touchDrag.js?v=67',
    './js/productions.js?v=67',
    './js/poolPlayout.js?v=67',
    './js/sources.js?v=67',
    './js/topbar.js?v=67',
    './js/app.js?v=67',
    './js/clock.js?v=67',
    './js/tutorial.js?v=67',
    './js/router-view.js?v=67',
    './js/captains-log.js?v=67',
    './js/portals.js?v=67',
    './js/lcars-pulse.js?v=67',
    './js/dest-selector.js?v=67',
    './js/dialog.js?v=67',
    './js/util/mono-emoji.js?v=67',
    './js/unroute.js?v=67',
