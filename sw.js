...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=99',
    './js/util/color.js?v=99',
    './js/util/palette.js?v=99',
    './js/util/dom.js?v=99',
    './js/core/state.js?v=99',
    './js/ui/makeMediaGroup.js?v=99',
    './js/globals.js?v=99',
    './js/poolVideo.js?v=99',
    './js/poolAudio.js?v=99',
    './js/visuals.js?v=99',
    './js/matrix.js?v=99',
    './js/editors/core.js?v=99',
    './js/editors/iso-recorder.js?v=99',
    './js/editors/multi-viewer.js?v=99',
    './js/editors/vision-mixer.js?v=99',
    './js/editors/audio-mixer.js?v=99',
    './js/editors/intercom.js?v=99',
    './js/editors/camera-control.js?v=99',
    './js/editors/camera/styles.js?v=99',
    './js/editors/camera/state.js?v=99',
    './js/editors/camera/scopes.js?v=99',
    './js/editors/camera/bars.js?v=99',
    './js/editors/camera/maps.js?v=99',
    './js/editors/camera/controls.js?v=99',
    './js/editors/audio-monitor.js?v=99',
    './js/editors/ifb.js?v=99',
    './js/editors/stagebox-input.js?v=99',
    './js/editors/encoder.js?v=99',
    './js/editors/signaling.js?v=99',
    './js/editors/lighting.js?v=99',
    './js/editors/wysiwyg.js?v=99',
    './js/editors/multi.js?v=99',
    './js/dragDrop.js?v=99',
    './js/touchDrag.js?v=99',
    './js/productions.js?v=99',
    './js/poolPlayout.js?v=99',
    './js/sources.js?v=99',
    './js/topbar.js?v=99',
    './js/app.js?v=99',
    './js/auth.js?v=99',
    ...
    './js/clock.js?v=99',
    './js/tutorial.js?v=99',
    './js/router-view.js?v=99',
    './js/captains-log.js?v=99',
    './js/portals.js?v=99',
    './js/lcars-pulse.js?v=99',
    './js/dest-selector.js?v=99',
    './js/dialog.js?v=99',
    './js/util/mono-emoji.js?v=99',
    './js/unroute.js?v=99',
    './js/source-filter.js?v=99',
