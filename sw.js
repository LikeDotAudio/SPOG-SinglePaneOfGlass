...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=59',
    './js/util/color.js?v=59',
    './js/util/palette.js?v=59',
    './js/util/dom.js?v=59',
    './js/core/state.js?v=59',
    './js/ui/makeMediaGroup.js?v=59',
    './js/globals.js?v=59',
    './js/poolVideo.js?v=59',
    './js/poolAudio.js?v=59',
    './js/visuals.js?v=59',
    './js/matrix.js?v=59',
    './js/editors/core.js?v=59',
    './js/editors/iso-recorder.js?v=59',
    './js/editors/multi-viewer.js?v=59',
    './js/editors/vision-mixer.js?v=59',
    './js/editors/audio-mixer.js?v=59',
    './js/editors/intercom.js?v=59',
    './js/dragDrop.js?v=59',
    './js/touchDrag.js?v=59',
    './js/productions.js?v=59',
    './js/poolPlayout.js?v=59',
    './js/sources.js?v=59',
    './js/topbar.js?v=59',
    './js/app.js?v=59',
    './js/clock.js?v=59',
    './js/tutorial.js?v=59',
    './js/router-view.js?v=59',
    './js/captains-log.js?v=59',
    './js/portals.js?v=59',
    './js/lcars-pulse.js?v=59',
    './js/dest-selector.js?v=59',
