...
const CACHE_VERSION = 'twist-v102';
...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=102',
    './js/util/color.js?v=102',
    './js/util/palette.js?v=102',
    './js/util/dom.js?v=102',
    './js/core/state.js?v=102',
    './js/ui/makeMediaGroup.js?v=102',
    './js/globals.js?v=102',
    './js/poolVideo.js?v=102',
    './js/poolAudio.js?v=102',
    './js/visuals.js?v=102',
    './js/matrix.js?v=102',
    './js/editors/core.js?v=102',
    './js/editors/iso-recorder.js?v=102',
    './js/editors/multi-viewer.js?v=102',
    './js/editors/vision-mixer.js?v=102',
    './js/editors/audio-mixer.js?v=102',
    './js/editors/intercom.js?v=102',
    './js/editors/camera-control.js?v=102',
    './js/editors/camera/styles.js?v=102',
    './js/editors/camera/state.js?v=102',
    './js/editors/camera/scopes.js?v=102',
    './js/editors/camera/bars.js?v=102',
    './js/editors/camera/maps.js?v=102',
    './js/editors/camera/controls.js?v=102',
    './js/editors/audio-monitor.js?v=102',
    './js/editors/ifb.js?v=102',
    './js/editors/stagebox-input.js?v=102',
    './js/editors/encoder.js?v=102',
    './js/editors/signaling.js?v=102',
    './js/editors/lighting.js?v=102',
    './js/editors/wysiwyg.js?v=102',
    './js/editors/multi.js?v=102',
    './js/dragDrop.js?v=102',
    './js/touchDrag.js?v=102',
    './js/productions.js?v=102',
    './js/poolPlayout.js?v=102',
    './js/sources.js?v=102',
    './js/topbar.js?v=102',
    './js/app.js?v=102',
    './js/auth.js?v=102',
    ...
    './js/clock.js?v=102',
    './js/tutorial.js?v=102',
    './js/router-view.js?v=102',
    './js/captains-log.js?v=102',
    './js/portals.js?v=102',
    './js/lcars-pulse.js?v=102',
    './js/dest-selector.js?v=102',
    './js/dialog.js?v=102',
    './js/util/mono-emoji.js?v=102',
    './js/unroute.js?v=102',
    './js/source-filter.js?v=102',
