...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=79',
    './js/util/color.js?v=79',
    './js/util/palette.js?v=79',
    './js/util/dom.js?v=79',
    './js/core/state.js?v=79',
    './js/ui/makeMediaGroup.js?v=79',
    './js/globals.js?v=79',
    './js/poolVideo.js?v=79',
    './js/poolAudio.js?v=79',
    './js/visuals.js?v=79',
    './js/matrix.js?v=79',
    './js/editors/core.js?v=79',
    './js/editors/iso-recorder.js?v=79',
    './js/editors/multi-viewer.js?v=79',
    './js/editors/vision-mixer.js?v=79',
    './js/editors/audio-mixer.js?v=79',
    './js/editors/intercom.js?v=79',
    './js/editors/camera-control.js?v=79',
    './js/dragDrop.js?v=79',
    './js/touchDrag.js?v=79',
    './js/productions.js?v=79',
    './js/poolPlayout.js?v=79',
    './js/sources.js?v=79',
    './js/topbar.js?v=79',
    './js/app.js?v=79',
    './js/clock.js?v=79',
    './js/tutorial.js?v=79',
    './js/router-view.js?v=79',
    './js/captains-log.js?v=79',
    './js/portals.js?v=79',
    './js/lcars-pulse.js?v=79',
    './js/dest-selector.js?v=79',
    './js/dialog.js?v=79',
    './js/util/mono-emoji.js?v=79',
    './js/unroute.js?v=79',
    './js/source-filter.js?v=79',
