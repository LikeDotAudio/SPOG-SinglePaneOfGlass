...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=48',
    './js/util/color.js?v=48',
    './js/util/palette.js?v=48',
    './js/util/dom.js?v=48',
    './js/core/state.js?v=48',
    './js/ui/makeMediaGroup.js?v=48',
    './js/globals.js?v=48',
    './js/poolVideo.js?v=48',
    './js/poolAudio.js?v=48',
    './js/visuals.js?v=48',
    './js/matrix.js?v=48',
    './js/editors/core.js?v=48',
    './js/editors/iso-recorder.js?v=48',
    './js/editors/multi-viewer.js?v=48',
    './js/editors/vision-mixer.js?v=48',
    './js/editors/audio-mixer.js?v=48',
    './js/editors/intercom.js?v=48',
    './js/dragDrop.js?v=48',
    './js/touchDrag.js?v=48',
    './js/productions.js?v=48',
    './js/poolPlayout.js?v=48',
    './js/sources.js?v=48',
    './js/topbar.js?v=48',
    './js/app.js?v=48',
    './js/clock.js?v=48',
    './js/tutorial.js?v=48',
    './js/router-view.js?v=48',
