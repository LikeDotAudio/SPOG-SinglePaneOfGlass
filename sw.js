...
const CACHE_VERSION = 'twist-v107';
...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=107',
    './js/util/color.js?v=107',
    './js/util/palette.js?v=107',
    './js/util/dom.js?v=107',
    './js/core/state.js?v=107',
    './js/ui/makeMediaGroup.js?v=107',
    './js/globals.js?v=107',
    './js/poolVideo.js?v=107',
    './js/poolAudio.js?v=107',
    './js/visuals.js?v=107',
    './js/matrix.js?v=107',
    './js/editors/core.js?v=107',
    './js/editors/iso-recorder.js?v=107',
    './js/editors/multi-viewer.js?v=107',
    './js/editors/vision-mixer.js?v=107',
    './js/editors/audio-mixer.js?v=107',
    './js/editors/intercom.js?v=107',
    './js/editors/camera-control.js?v=107',
    './js/editors/camera/styles.js?v=107',
    './js/editors/camera/state.js?v=107',
    './js/editors/camera/scopes.js?v=107',
    './js/editors/camera/bars.js?v=107',
    './js/editors/camera/maps.js?v=107',
    './js/editors/camera/controls.js?v=107',
    './js/editors/audio-monitor.js?v=107',
    './js/editors/ifb.js?v=107',
    './js/editors/stagebox-input.js?v=107',
    './js/editors/encoder.js?v=107',
    './js/editors/signaling.js?v=107',
    './js/editors/lighting.js?v=107',
    './js/editors/wysiwyg.js?v=107',
    './js/editors/multi.js?v=107',
    './js/dragDrop.js?v=107',
    './js/touchDrag.js?v=107',
    './js/productions.js?v=107',
    './js/poolPlayout.js?v=107',
    './js/sources.js?v=107',
    './js/topbar.js?v=107',
    './js/app.js?v=107',
    './js/auth.js?v=107',
    './js/schedule.js?v=107',
    './js/mission.js?v=107',
    './js/dest-glow.js?v=107',
    './js/clock.js?v=107',
    './js/tutorial.js?v=107',
    './js/router-view.js?v=107',
    './js/captains-log.js?v=107',
    './js/portals.js?v=107',
    './js/lcars-pulse.js?v=107',
    './js/dest-selector.js?v=107',
    './js/dialog.js?v=107',
    './js/util/mono-emoji.js?v=107',
    './js/unroute.js?v=107',
    './js/source-filter.js?v=107',
