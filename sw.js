...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=86',
    './js/util/color.js?v=86',
    './js/util/palette.js?v=86',
    './js/util/dom.js?v=86',
    './js/core/state.js?v=86',
    './js/ui/makeMediaGroup.js?v=86',
    './js/globals.js?v=86',
    './js/poolVideo.js?v=86',
    './js/poolAudio.js?v=86',
    './js/visuals.js?v=86',
    './js/matrix.js?v=86',
    './js/editors/core.js?v=86',
    './js/editors/iso-recorder.js?v=86',
    './js/editors/multi-viewer.js?v=86',
    './js/editors/vision-mixer.js?v=86',
    './js/editors/audio-mixer.js?v=86',
    './js/editors/intercom.js?v=86',
    './js/editors/camera-control.js?v=86',
    './js/editors/camera/styles.js?v=86',
    './js/editors/camera/state.js?v=86',
    './js/editors/camera/scopes.js?v=86',
    './js/editors/camera/bars.js?v=86',
    './js/editors/camera/maps.js?v=86',
    './js/editors/camera/controls.js?v=86',
    './js/editors/audio-monitor.js?v=86',
    './js/editors/ifb.js?v=86',
    './js/editors/stagebox-input.js?v=86',
    './js/editors/encoder.js?v=86',
    './js/editors/multi.js?v=86',
    './js/dragDrop.js?v=86',
    './js/touchDrag.js?v=86',
    './js/productions.js?v=86',
    './js/poolPlayout.js?v=86',
    './js/sources.js?v=86',
    './js/topbar.js?v=86',
    './js/app.js?v=86',
    './js/clock.js?v=86',
    './js/tutorial.js?v=86',
    './js/router-view.js?v=86',
    './js/captains-log.js?v=86',
    './js/portals.js?v=86',
    './js/lcars-pulse.js?v=86',
    './js/dest-selector.js?v=86',
    './js/dialog.js?v=86',
    './js/util/mono-emoji.js?v=86',
    './js/unroute.js?v=86',
    './js/source-filter.js?v=86',
