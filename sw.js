...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=97',
    './js/util/color.js?v=97',
    './js/util/palette.js?v=97',
    './js/util/dom.js?v=97',
    './js/core/state.js?v=97',
    './js/ui/makeMediaGroup.js?v=97',
    './js/globals.js?v=97',
    './js/poolVideo.js?v=97',
    './js/poolAudio.js?v=97',
    './js/visuals.js?v=97',
    './js/matrix.js?v=97',
    './js/editors/core.js?v=97',
    './js/editors/iso-recorder.js?v=97',
    './js/editors/multi-viewer.js?v=97',
    './js/editors/vision-mixer.js?v=97',
    './js/editors/audio-mixer.js?v=97',
    './js/editors/intercom.js?v=97',
    './js/editors/camera-control.js?v=97',
    './js/editors/camera/styles.js?v=97',
    './js/editors/camera/state.js?v=97',
    './js/editors/camera/scopes.js?v=97',
    './js/editors/camera/bars.js?v=97',
    './js/editors/camera/maps.js?v=97',
    './js/editors/camera/controls.js?v=97',
    './js/editors/audio-monitor.js?v=97',
    './js/editors/ifb.js?v=97',
    './js/editors/stagebox-input.js?v=97',
    './js/editors/encoder.js?v=97',
    './js/editors/signaling.js?v=97',
    './js/editors/lighting.js?v=97',
    './js/editors/wysiwyg.js?v=97',
    './js/editors/multi.js?v=97',
    './js/dragDrop.js?v=97',
    './js/touchDrag.js?v=97',
    './js/productions.js?v=97',
    './js/poolPlayout.js?v=97',
    './js/sources.js?v=97',
    './js/topbar.js?v=97',
    './js/app.js?v=97',
    './js/auth.js?v=97',
    ...
    './js/clock.js?v=97',
    './js/tutorial.js?v=97',
    './js/router-view.js?v=97',
    './js/captains-log.js?v=97',
    './js/portals.js?v=97',
    './js/lcars-pulse.js?v=97',
    './js/dest-selector.js?v=97',
    './js/dialog.js?v=97',
    './js/util/mono-emoji.js?v=97',
    './js/unroute.js?v=97',
    './js/source-filter.js?v=97',
