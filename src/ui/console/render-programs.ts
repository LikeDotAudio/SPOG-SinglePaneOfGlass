// src/ui/console/render-programs — ports js/productions.js renderPrograms (a
// production → a program row of twist drop-targets), plus its gang/wrap helpers.
// Twists are the crosspoints sources route into (wired by ui/console/matrix.ts).
// The destination tree that mounts these rooms lives in ui/console/destinations.ts.
import { isFaultStatus } from '../../domain/routing-core/index.js';
import type { Production, TwistConfig } from '../../model/index.js';
import { monoEmoji, faultTag } from '../sources/format.js';
