...
import {
  mkChannel,
  type ChanId, type Channel, type EngineHooks, type GpiWhen, type TimerState,
} from './engine-types.js';

// Re-export the state shapes so consumers importing from './engine.js' keep resolving.
export type {
  ChanId, GpiWhen, Preset, GpiOut, GpiIn, Channel, TimerState, EngineHooks,
} from './engine-types.js';
